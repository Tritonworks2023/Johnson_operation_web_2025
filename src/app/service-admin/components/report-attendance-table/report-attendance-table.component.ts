...
export class ReportAttendanceTableComponent implements OnInit {
  ...
  constructor(private _api: ApiService, public dialog: MatDialog, @Inject(SESSION_STORAGE) private storage: StorageService) { }
  ...
  {
    console.log(item)
    this.storage.set('employee_id_data',item);
